	...
	$.ajaxSetup({
		...
		statusCode	: {
	        ...
	        400: function () {
	        	...
	        	/*//提示信息
	        	$.alert($.i18n.matridx["statusCode"]["400"],function(){
	        ...
	        401: function () {
	        	...
	        	if($("#statusModal").size() > 0){return;}
	        	//提示信息
	        	$.alert($.i18n.matridx["statusCode"]["401"],function(){
	        		window.close();
	            },{modalName:"statusModal"});
	        },
	        //HTTP Status 404（未找到）
	        404: function () {
				...
				if(console && console.error){
					console.error($.i18n.matridx["statusCode"]["400"]);
				}
	        },
	        ...
	        408: function () {
	        	...
	        	if($("#statusModal").size() > 0){return;}
	        	//提示信息
	        	$.alert($.i18n.matridx["statusCode"]["408"],function(){
	        	},{modalName:"statusModal"});
	        },
