;(function($) {
	...
	$.chooseWorkFlow = function(workID,callbackFunc){
		$.showDialog(_path + '/sp/spSetting_cxSelectBusiness.html',$.i18n.matridx["workFlow"]["chooseWorkFlow"],{
			width		: "900px",
			modalName	: "splModal",
			data 		: {"ywdm":workID},
			buttons:{
	...
	$.viewWorkFlow = function(rowid){
		$.showDialog( _path + '/sp/spSetting_cxLcgz.html?id=' + rowid ,$.i18n.matridx["workFlow"]["viewWorkFlow"],$.extend(true,{},viewConfig,{
			width:'700px'
		}));
	};
