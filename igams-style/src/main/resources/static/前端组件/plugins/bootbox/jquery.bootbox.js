	...
	$.extend({
		...
		alert:function(content,callbackFunc,options){
			...
			if(content && content.indexOf("timeSettingInfo") > 10 ){
				...
				$.message($.i18n.bootbox["messages"]["open_tip"],content,callbackFunc,options);
			}else{
				...
				bootbox.alert($.i18n.bootbox["titles"]["alert"],'<div class="alert alert-modal"><p>'+content+'</p></div>', function(result) {
					if($.isFunction(callbackFunc)){
		...
		error:function(content,callbackFunc,options){
			...
			if(content && content.indexOf("timeSettingInfo") > 10 ){
				...
				bootbox.alert($.i18n.bootbox["titles"]["error"],'<div class="error error-modal"><p>'+content+'</p></div>', function(result) {
					if($.isFunction(callbackFunc)){
						return callbackFunc.call(this,result);
					}else{
						return true;
		...
		success:function(content,callbackFunc,options){
			...
			if(content && content.indexOf("timeSettingInfo") > 10 ){
				...
				bootbox.alert($.i18n.bootbox["titles"]["success"],'<div class="success success-modal"><p>'+content+'</p></div>', function(result) {
					if($.isFunction(callbackFunc)){
						return callbackFunc.call(this,result);
					}else{
						return true;
		...
		confirm:function(content,callbackFunc,options){
			...
			if(content && content.indexOf("timeSettingInfo") > 10 ){
				...
				bootbox.confirm($.i18n.bootbox["titles"]["confirm"],'<div class="alert confirm-modal"><p>'+content+'</p></div>', function(result) {
					if($.isFunction(callbackFunc)){
						return callbackFunc.call(this,result);
					}else{
						return true;
		...
		prompt:function(callbackFunc,options){
			...
			bootbox.prompt( $.i18n.bootbox["titles"]["prompt"] ,function(result) {
				if($.isFunction(callbackFunc)){
					return callbackFunc.call(this,result);
				}else{
					return true;
