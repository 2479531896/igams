...
(function (root, factory) {
  ...
  var templates = {
    ...
    fullScreen:"<div class='bootbox-full'><span class='fa fa-arrows-alt'></span></div>",
  ...
  exports.dialog = function(options) {
    ...
    if (options.max_height) {
    	dialog.find('.modal-body').css('max-height',max_height);
    }else{
    	setBodyMaxHeight();
    }
    ...
    if (options.fullScreen) {
    	...
    	$(document).off('click','.bootbox-full').on('click','.bootbox-full',function(){
    		if(dialog.hasClass('box-full-screen')){
    			...
    			dialog.find('.modal-header .fa-minus-square-o').addClass('fa-arrows-alt').removeClass('fa-minus-square-o');
    		}else{
    			dialog.addClass('box-full-screen');
    			dialog.find('.modal-header .fa-arrows-alt').addClass('fa-minus-square-o').removeClass('fa-arrows-alt');
    		}
