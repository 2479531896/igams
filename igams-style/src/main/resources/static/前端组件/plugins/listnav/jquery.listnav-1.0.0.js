...
jQuery(function($) {
	...
	$.bootui.widget.ListNav = function(target,options){
	...
	/* listnav plugin definition  */
	
	$.fn.listnav = function(option){
		//处理后的参数
		...
		return this.each(function () {
			var $this = $(this);
			var data = $this.data('widget.listnav');
			if (!data && option == 'destroy') {return;}
			if (!data){
				var options = $.extend(true,{}, $.fn.listnav.defaults, $this.data(), ((typeof option == 'object' && option) ? option : {}));
				$this.data('widget.listnav', (data = new $.bootui.widget.ListNav(this, options)));
			}
	...
	$.fn.listnav.Constructor = $.bootui.widget.ListNav;
	
	$.fn.extend({
		listnav:function(options){
			return new $.bootui.widget.ListNav(this, options);
		}
	});
