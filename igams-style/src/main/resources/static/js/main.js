...
//    });
    ...
    //BEGIN TOOTLIP
    $("[data-bs-toggle='tooltip'], [data-hover='tooltip']").tooltip();
    //END TOOLTIP

    //BEGIN POPOVER
    $("[data-bs-toggle='popover'], [data-hover='popover']").popover();
    //END POPOVER
...
//  $('.reportrange span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
    ...
    $(document).off('click','#home-page').on('click','#home-page',function(){
    	...
    	//控制台样式
    	if((! $(this).hasClass('active')) && $('.page-content').find('.has-new-tab').length>0){
    		$(this).addClass('active');
