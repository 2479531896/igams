 ...
 */
//;(function(a){a.extend(Array.prototype,{avg:function(){var c=0;for(var b=0;b<this.length;b++){c+=this[b]}return c/this.length},d:function(){if(this.length>0){return this.max()-this.min()}else{return null}},max:function(){if(this.length>0){var b=this[0];for(var c=1;c<this.length;c++){b=Math.max(b,this[c])}return b}else{return null}},min:function(){if(this.length>0){var c=this[0];for(var b=1;b<this.length;b++){c=Math.min(c,this[b])}return c}else{return null}},ku:function(){if(this.length>0){return 0}else{return null}},\u03c3:function(){if(this.length>0){return Math.sqrt(this.s())}else{return null}},s:function(){if(this.length>0){var d=this.avg();var c=0;for(var b=1;b<this.length;b++){c+=(this[b-1]-d)*(this[b]-d)}return c/this.length}else{return null}},sk:function(){if(this.length>0){return(this.avg()-this.me())/this.\u03c3()}else{return null}},me:function(){if(this.length>0){if(this.length%2==0){return[this[this.length/2-1],this[this.length/2]].avg()}else{return this[(this.length-1)/2]}}else{return null}},mo:function(){var c=new Array(0);if(this.length>0){var g=new Array(this.length);for(var f=0;f<this.length;f++){g[f]=0;for(var e=0;e<this.length;e++){if(this[f]==this[e]){g[f]++}}}var b=false;for(var f=0;f<g.length;f++){if(1==g[f]){b=true}else{b=false;break}}if(!b){var d=g.max();for(var f=0;f<this.length;f++){if(g[f]==d){c.push(this[f])}}}}return c},asc:function(e,f){var d=f||window;var b=Array(this);if(e){return b.sort(function(h,g){return e.call(d,h,g,b)})}else{var c=b.every(function(h,g){return !isNaN(g)});if(c){return b.sort(function(h,g){return h-g})}else{return b.sort(function(h,g){return String(h).localeCompare(String(g))})}}},desc:function(e,f){var d=f||window;var b=Array(this);if(e){return b.sort(function(h,g){return e.call(d,g,h,b)})}else{var c=b.every(function(h,g){return !isNaN(g)});if(c){return b.sort(function(h,g){return g-h})}else{return b.sort(function(h,g){return String(g).localeCompare(String(h))})}}},extend:function(c){var b=Array(this);a.each(c||{},function(e,d){b.push(e)});return b},every:function(e,f){var d=f||window;for(var c=0,b=this.length;c<b;++c){if(!e.call(d,c,this[c],this)){return false}}return true},some:function(e,f){var d=f||window;for(var c=0,b=this.length;c<b;++c){if(e.call(d,c,this[c],this)){return true}}return false},filter:function(f,g){var e=g||window;var b=[];for(var d=0,c=this.length;d<c;++d){if(!f.call(e,d,this[d],this)){continue}b.push(this[d])}return b},compare:function(e,f){var d=f||window;var b=true;for(var c=0;c<this.length-1;c++){b=e.call(d,this[c],this[c+1]);if(!b){break}}return b},shuffle:function(){var c=this;for(var d,b,e=c.length;e;d=parseInt(Math.random()*e),b=c[--e],c[e]=c[d],c[d]=b){}return c},unique:function(){var c=this,e=[],d=c.length,f,b,g;for(b=0;b<d;b++){f=undefined;for(g=0;g<e.length;g++){if(c[b]===e[g]){f=true;break}}if(!f){e.push(c[b])}}return e},indexOf:function(c,d){var d=d||0;for(var b=0;b<this.length;++b){if(this[b]===c){return b}}return -1},lastIndexOf:function(c,d){var d=d||this.length;if(d>=this.length){d=this.length}if(d<0){d=this.length+d}for(var b=d;b>=0;--b){if(this[b]===c){return b}}return -1},contains:function(c,e){var d=false,e=e||0;for(var b=e;b<this.length;b++){if(c==this[b]){d=true;break}}return d},isEmpty:function(){return(this&&this.length>0)?false:true},include:function(b){if(this.indexOf(b)<0){this.push(b)}return this},erase:function(c){var b=this.indexOf(c);if(b!=-1){this.splice(b,1)}return this},remove:function(c){if(c<0||c>this.length){return this}else{var b=[];for(var d=0;d<this.length;d++){if(d!=c){b.push(this[d])}}return b}},removeAt:function(c){var b=this[0];return b.splice(c,1)[0]},set:function(b,c){if(this.lenght==0||b<0||b>this.lenght){this.push(c)}else{this.splice(b,1,c)}return this},get:function(b){if(this.lenght==0||b<0||b>this.lenght){return null}else{return this[b]}},first:function(e,f){var d=f||window;var b=null;if(this.length>0){for(var c=0;c<this.length;c++){if(e.call(d,c,this[c])){b=this[c];break}}}return b},last:function(b,c){return this.reverse().first(b,c)},random:function(){var b=this.length;function c(){var d=Math.ceil(Math.random()*Math.pow(10,String(b).length));return d>=b?c():d}return this.length>0?this[c()]:null},union:function(c){return this.concat(c).unique()},reiteration:function(){var d=0;for(var e=0;e<this.length;e++){var b=this[e];for(var c=(e+1);c<this.length;c++){if(b==this[c]){d++}}}return d},intersect:function(){var b=[];for(var e=0;e<this.length;e++){var c=this[e];for(var d=(e+1);d<this.length;d++){if(c==this[d]){b.push(c)}}}return b},toPlanString:function(){var b=this.some(function(c,d,e){return a.isArray(d)||a.isFunction(d)||a.isPlainObject(d)});return(b&&JSON)?JSON.stringify(this):this.toString()}})}(jQuery));
/*
