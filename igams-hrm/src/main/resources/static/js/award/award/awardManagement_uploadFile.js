                ...
                setTimeout(function(){
                    if(responseText["status"] == 'success'){
                        $.success(responseText["message"],function() {
                            ...
                            var arr=$("#ajaxForm #fjids").val().split(",");
                            var str="";
                            ...
                            if(str&&str!=""){
                                $("#ajaxForm #fjids").val(str.substring(1));
                            }else{
...
$(function(){
    ...
    var upload_params = [];
    upload_params.prefix = $("#ajaxForm #urlPrefix").val();
    oFileInput.Init("ajaxForm","displayUpInfo",2,1,"pro_file",null,upload_params);
})