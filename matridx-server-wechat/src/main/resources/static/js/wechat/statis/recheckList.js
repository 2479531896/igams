var Recheck_TableInit=function(){
	...
	oTableInit.Init=function(){
		$("#recheck_formSearch  #recheck_list").bootstrapTable({
			url: '/wechat/recheck/RecheckStatisPage',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
	...
	oTableInit.queryParams=function(params){
		var map = {   // 这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
		 ...
		 map["lrsj"]=$("#lrsj").val();
		 map["xh"]=$("#xh").val();
		 map["lrsjstart"]=$("#lrsjstart").val();
		 map["lrsjend"]=$("#lrsjend").val();
		 map["lrsjMstart"]=$("#lrsjMstart").val();
		 map["lrsjMend"]=$("#lrsjMend").val();
		 map["lrsjYstart"]=$("#lrsjYstart").val();
		 map["lrsjYend"]=$("#lrsjYend").val();
		return map;
		};
	return oTableInit;
}
 ...
 */
function back_view(){
	var jsrq=$("#recheck_formSearch #jsrq").val();
 ...
 */
function back_week(){
	var jsrqstart = $("#recheck_formSearch #lrsjstart").val();
	var jsrqend = $("#recheck_formSearch #lrsjend").val();
