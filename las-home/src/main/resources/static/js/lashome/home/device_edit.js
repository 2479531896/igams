...
function displayUpInfo(fjid){
	if(!$("#editDevice_Form #fjids").val()){
		$("#editDevice_Form #fjids").val(fjid);
	}else{
		$("#editDevice_Form #fjids").val($("#editDevice_Form #fjids").val()+","+fjid);
	}
}
...
$(document).ready(function() {
	...
	oFileInput.Init("editDevice_Form","displayUpInfo",2,1,"device_file",null,null);
	// 所有下拉框添加choose样式
	jQuery('#editDevice_Form .chosen-select').chosen({ width : '100%' });
});