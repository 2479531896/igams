...
function displayUpInfo(fjid){
	if(!$("#importLibForm #fjids").val()){
		$("#importLibForm #fjids").val(fjid);
	}else{
		$("#importLibForm #fjids").val($("#importLibForm #fjids").val()+","+fjid);
	}
}
$(function(){
	//0.初始化fileinput
	...
	var sign_params=[];
	oFileInput.Init("importLibForm","displayUpInfo",2,1,"pro_file",null);
	jQuery('#importLibForm .chosen-select').chosen({width: '100%'});
})