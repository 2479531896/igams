...
function editfile(divName,btnName){
	$("#hzxx_ajaxForm"+"  #"+btnName).hide();
	$("#hzxx_ajaxForm"+"  #"+divName).show();
}
//关闭文件上传界面
function cancelfile(divName,btnName){
	$("#hzxx_ajaxForm"+"  #"+btnName).show();
	$("#hzxx_ajaxForm"+"  #"+divName).hide();
}
function initPage() {
	if ($('#sfsd').is(':checked'))
...
//添加日期控件
laydate.render({
	elem: '#hzxx_ajaxForm #jlrqThree'
	, theme: '#2381E9'
});
//添加日期控件
laydate.render({
	elem: '#hzxx_ajaxForm #jlrqFive'
	, theme: '#2381E9'
});
//添加日期控件
laydate.render({
	elem: '#hzxx_ajaxForm #jlrqSeven'
	, theme: '#2381E9'
});
//添加日期控件
laydate.render({
...
//添加日期控件
laydate.render({
	elem: ' #hzxx_ajaxForm #xghxytysjhz'
	, theme: '#2381E9'
	, type: 'datetime'
	, format: 'yyyy-MM-dd HH:mm'//保留时分
});
