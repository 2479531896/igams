var Spyq_turnOff=true;
var AllSpyq_TableInit=function(){
	var oTableInit = new Object();
	oTableInit.Init=function(){
		$("#allspyq_formSearch #allspyq_list").bootstrapTable({
//			url: $("#allspyq_formSearch #urlPrefix").val()+'/systemmain/audit/getOneSpyqData?pageFlag='+$("#allspyq_formSearch #flag").val(),  
			url: $("#allspyq_formSearch #urlPrefix").val()+'/systemmain/audit/pageGetListOneSpyq',
			method: 'get',                      // 请求方式（*）
...
/*-------------------------------------------------------------*/
        $("#allspyq_formSearch #sl_searchMore").on("click",function(ev){
        	var ev=ev||event; 
        	if(Spyq_turnOff){
        		$("#allspyq_formSearch #searchMore").slideDown("low");
        		Spyq_turnOff = false;
        		this.innerHTML="基本筛选";
        	}else{
        		$("#allspyq_formSearch #searchMore").slideUp("low");
        		Spyq_turnOff=true;
        		this.innerHTML="高级筛选";
        	}
...
$(function(){
    ...
    $("#allspyq_formSearch [name='more']").each(function(){
