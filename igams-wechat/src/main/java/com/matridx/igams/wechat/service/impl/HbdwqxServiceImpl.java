...
import com.matridx.igams.wechat.dao.post.IHbdwqxDao;
...
public class HbdwqxServiceImpl extends BaseBasicServiceImpl<HbdwqxDto, HbdwqxModel, IHbdwqxDao> implements IHbdwqxService{
	 ...
	 */
	@Override
	public List<HbdwqxDto> getJcdwSelectedList(HbdwqxDto hbdwqxDto) {
		// TODO Auto-generated method stub
		return dao.getJcdwSelectedList(hbdwqxDto);
	}
