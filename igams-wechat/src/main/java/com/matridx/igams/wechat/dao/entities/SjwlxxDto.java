...
@Alias(value="SjwlxxDto")
public class SjwlxxDto extends SjwlxxModel{
	//寄送方式代码
	...
	//团单接单人
	private String tdjdrmc;
	//团单接单人钉钉id
	private String tdjdrddid;
	//用户名
	private String yhm;
	...
	public String getTdjdrmc() {
		return tdjdrmc;
	}

	public void setTdjdrmc(String tdjdrmc) {
		this.tdjdrmc = tdjdrmc;
	}

	public String getTdjdrddid() {
		return tdjdrddid;
	}

	public void setTdjdrddid(String tdjdrddid) {
		this.tdjdrddid = tdjdrddid;
	}
	...
	public void setWlids(String[] wlids) {
		this.wlids = wlids;
	}
	...
	public String getWlids_str() {
		return wlids_str;
	}

	public void setWlids_str(String wlids_str) {
		this.wlids_str = wlids_str;
	}
