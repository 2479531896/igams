function showTable(){
	$("#verifView_Form #fjcfbDto2").attr("style","")
	$("#verifView_Form #show").attr("style","display: none")
	$("#verifView_Form #hide").attr("style","display: block")
}
function hideTable(){
	$("#verifView_Form #fjcfbDto2").attr("style","display: none;")
	$("#verifView_Form #show").attr("style","display: block")
	$("#verifView_Form #hide").attr("style","display: none")
}
