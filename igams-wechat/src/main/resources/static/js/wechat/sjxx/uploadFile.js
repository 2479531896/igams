...
function getPagData(){
    $.ajax({
        url: '/ws/inspection/pagedataGetInfo',
        type:'post',
        dataType:'json',
        data:{
        ...
        success:function(data){
            $("#ajaxForm #flag").val(data.flag);
            $("#ajaxForm #flagmc").text(data.flagmc);
            $("#ajaxForm #ywlx").val(data.ywlx);
            $("#ajaxForm #sjid").val(data.sjid);
            $("#ajaxForm #ybbh").text(data.ybbh);
            $("#ajaxForm #hzxm").text(data.hzxm);
            $("#ajaxForm #nbbm").text(data.nbbm);
            $("#ajaxForm #jcxmmc").text(data.jcxmmc);
            $("#ajaxForm #yblxmc").text(data.yblxmc);
...
function sendMessage(){
    ...
    if ( !$("#ajaxForm #flag").val()){
        $.alert("上传未知类型");
        return
    }
    $.ajax({
        url: '/ws/inspection/pagedataSendMessage',
        type:'post',
        dataType:'json',
        data:{
            "key" : $("#ajaxForm #key").val(),
...
$("#ajaxForm #file").click(function(){
    if (!$("#ajaxForm #ywlx").val()){
        $.alert("请刷新页面获取到数据后在上传附件！");
        return false;
    }
})
