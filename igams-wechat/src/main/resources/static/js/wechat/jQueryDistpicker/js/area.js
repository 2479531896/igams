var provinceList = [
    {name:'北京市', cityList:[
        {name:'东城区', areaList:['东城区']},
        {name:'西城区', areaList:['西城区']},
        {name:'崇文区', areaList:['崇文区']},
        {name:'宣武区', areaList:['宣武区']},
        {name:'朝阳区', areaList:['朝阳区']},
        {name:'丰台区', areaList:['丰台区']},
        {name:'石景山区', areaList:['石景山区']},
        {name:'海淀区', areaList:['海淀区']},
        {name:'门头沟区', areaList:['门头沟区']},
        {name:'房山区', areaList:['房山区']},
        {name:'通州区', areaList:['通州区']},
        {name:'顺义区', areaList:['顺义区']},
        {name:'昌平区', areaList:['昌平区']},
        {name:'大兴区', areaList:['大兴区']},
        {name:'怀柔区', areaList:['怀柔区']},
        {name:'平谷区', areaList:['平谷区']},
        {name:'密云县', areaList:['密云县']},
        {name:'延庆县', areaList:['延庆县']}
        ]},
    {name:'上海市', cityList:[
        {name:'黄浦区', areaList:['黄浦区']},
        {name:'卢湾区', areaList:['卢湾区']},
        {name:'徐汇区', areaList:['徐汇区']},
        {name:'静安区', areaList:['静安区']},
        {name:'普陀区', areaList:['普陀区']},
        {name:'闸北区', areaList:['闸北区']},
        {name:'虹口区', areaList:['虹口区']},
        {name:'杨浦区', areaList:['杨浦区']},
        {name:'闵行区', areaList:['闵行区']},
        {name:'宝山区', areaList:['宝山区']},
        {name:'嘉定区', areaList:['嘉定区']},
        {name:'浦东新区', areaList:['浦东新区']},
        {name:'金山区', areaList:['金山区']},
        {name:'松江区', areaList:['松江区']},
        {name:'青浦区', areaList:['青浦区']},
        {name:'南汇区', areaList:['南汇区']},
        {name:'奉贤区', areaList:['奉贤区']},
        {name:'崇明县', areaList:['崇明县']}
    ]},
    {name:'天津市', cityList:[
        {name:'和平区', areaList:['和平区']},
        {name:'河东区', areaList:['河东区']},
        {name:'河西区', areaList:['河西区']},
        {name:'南开区', areaList:['南开区']},
        {name:'河北区', areaList:['河北区']},
        {name:'红桥区', areaList:['红桥区']},
        {name:'塘沽区', areaList:['红桥区']},
        {name:'汉沽区', areaList:['汉沽区']},
        {name:'大港区', areaList:['大港区']},
        {name:'东丽区', areaList:['东丽区']},
        {name:'西青区', areaList:['西青区']},
        {name:'津南区', areaList:['津南区']},
        {name:'北辰区', areaList:['北辰区']},
        {name:'武清区', areaList:['武清区']},
        {name:'宝坻区', areaList:['宝坻区']},
        {name:'宁河县', areaList:['宁河县']},
        {name:'静海县', areaList:['静海县']},
        {name:'蓟　县', areaList:['蓟　县']}
    ]},
    {name:'重庆市', cityList:[
        {name:'万州区', areaList:['万州区']},
        {name:'涪陵区', areaList:['涪陵区']},
        {name:'渝中区', areaList:['渝中区']},
        {name:'大渡口区', areaList:['大渡口区']},
        {name:'江北区', areaList:['江北区']},
        {name:'沙坪坝区', areaList:['沙坪坝区']},
        {name:'九龙坡区', areaList:['九龙坡区']},
        {name:'南岸区', areaList:['南岸区']},
        {name:'北碚区', areaList:['北碚区']},
        {name:'万盛区', areaList:['万盛区']},
        {name:'双桥区', areaList:['双桥区']},
        {name:'渝北区', areaList:['渝北区']},
        {name:'巴南区', areaList:['巴南区']},
        {name:'黔江区', areaList:['黔江区']},
        {name:'长寿区', areaList:['长寿区']},
        {name:'江津市', areaList:['江津市']},
        {name:'合川市', areaList:['合川市']},
        {name:'永川市', areaList:['永川市']},
        {name:'南川市', areaList:['南川市']},
        {name:'綦江县', areaList:['綦江县']},
        {name:'潼南县', areaList:['潼南县']},
        {name:'铜梁县', areaList:['铜梁县']},
        {name:'大足县', areaList:['大足县']},
        {name:'荣昌县', areaList:['荣昌县']},
        {name:'璧山县', areaList:['璧山县']},
        {name:'梁平县', areaList:['梁平县']},
        {name:'城口县', areaList:['城口县']},
        {name:'丰都县', areaList:['丰都县']},
        {name:'垫江县', areaList:['垫江县']},
        {name:'武隆县', areaList:['武隆县']},
        {name:'忠　县', areaList:['忠　县']},
        {name:'开　县', areaList:['开　县']},
        {name:'云阳县', areaList:['云阳县']},
        {name:'奉节县', areaList:['奉节县']},
        {name:'巫山县', areaList:['巫山县']},
        {name:'巫溪县', areaList:['巫溪县']},
        {name:'石柱土家族自治县', areaList:['石柱土家族自治县']},
        {name:'秀山土家族苗族自治县', areaList:['秀山土家族苗族自治县']},
        {name:'酉阳土家族苗族自治县', areaList:['酉阳土家族苗族自治县']},
        {name:'彭水苗族土家族自治县', areaList:['彭水苗族土家族自治县']}
    ]},
    {name:'广东省', cityList:[
