var Recheck_TableInit=function(){
	...
	oTableInit.Init=function(){
		$("#recheck_jsrq_formSearch  #recheck_list").bootstrapTable({
			url: '/ws/recheck/RecheckStatisPage',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            toolbar: '#recheck_jsrq_formSearch #toolbar',                //工具按钮用哪个容器
            ...
            onDblClickRow: function (row, $element) {
            	/*Partner_DealById(row.hbid,'view',$("#recheck_jsrq_formSearch #recheck_list").attr("tourl"));*/
             },
		});
	}
 ...
 */
function back_view(){
	var jsrq=$("#recheck_jsrq_formSearch #jsrq").val();
