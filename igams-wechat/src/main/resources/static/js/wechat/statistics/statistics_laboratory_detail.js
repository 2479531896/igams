/*模态框 动画*/
$('.statistics_laboratory_modal_button').click(function(){
    var buttonId = $(this).attr('id');
    $('#statistics_laboratory_modal_container').removeAttr('class').addClass(buttonId);
    $('body').addClass('statistics_laboratory_modal_active');
})

$('#statistics_laboratory_modal_container').click(function(){
    $(this).addClass('out');
    $('body').removeClass('statistics_laboratory_modal_active');
});

function getBackStatisticsLaboratory() {
    $("#statistics_laboratory").load("/wechat/statistics/pageStatisticsLaboratoryStatistics");
