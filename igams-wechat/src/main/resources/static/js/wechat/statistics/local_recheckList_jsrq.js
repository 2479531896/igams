var Recheck_TableInit=function(){
	...
	oTableInit.Init=function(){
		$("#local_recheck_jsrq_formSearch  #recheck_list").bootstrapTable({
			url: '/ws/recheck/RecheckStatisPage',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            toolbar: '#local_recheck_jsrq_formSearch #toolbar',                //工具按钮用哪个容器
 ...
 */
function back_view(){
	$("#weeklyStatis").load("/wechat/statistics/pageListLocal_weekly_jsrq");
}
$(function(){
// 1.初始化Table
