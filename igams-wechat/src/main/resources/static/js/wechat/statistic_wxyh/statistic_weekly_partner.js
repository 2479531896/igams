...
console.log('11');
	...
	setTimeout(function(){
		...
		//加载数据
		var _url = "/ws/ststictis/getPartnerStatisWeekly";
		var param ={};
		...
		param["yhid"]= $("#weekly_Statis_partner #yhid").val()
...
function echartsBtnInit(_renderArr){
	...
	map["yhid"]= $("#weekly_Statis_partner #yhid").val()
	...
	$("#weekly_Statis_partner #tj3q").unbind("click").click(function(){
	    ...
	    map["dbhbs"]= $("#weekly_Statis_partner #dbhbs").val();
		map["dbs"]= $("#weekly_Statis_partner #dbhbs").val();
		map["dbmcs"]= $("#weekly_Statis_partner #dbhbs").val();
	...
	$("#weekly_Statis_partner a[name='tj1q']").unbind("click").click(function(e){
		...
		map["hbfl"]= $("#weekly_Statis_partner #hbfl").val();
		map["hbzfl"]= $("#weekly_Statis_partner #hbzfl").val();
		var hbmc = $("#weekly_Statis_partner #"+e.currentTarget.id).attr("dm");
		map["dbmcs"]=hbmc;
		map["dbs"]=hbmc;
	    map["dbhbs"]= $("#weekly_Statis_partner #dbhbs").val();
...
console.log($("#weekly_Statis_partner #yhid").val());
    var bj = $("#weekly_Statis_partner #bj").val();
    if(bj=='1'){//返回不同的页面
        $("#weekly_Statis_partner").load("/ws/statictis/backWeeklyByYhid?sign="+$("#sign").val()+"&jsrqstart="+$("#jsrqstart").val()+"&jsrqend="+$("#jsrqend").val()+"&yhid="+$("#weekly_Statis_partner #yhid").val());
    }else{
    	$("#weekly_Statis_partner").load("/ws/statictis/backWeeklyByYhid?jsrqstart="+$("#jsrqstart").val()+"&jsrqend="+$("#jsrqend").val()+"&yhid="+$("#weekly_Statis_partner #yhid").val()+"&xsbj=1");
    }
}
