 ...
 * @returns
 */
$("#statisticwxyh_daily #attainmentrate #rollbackweekly").bind("click",function(){
	var yhid = $("#statisticwxyh_daily #attainmentrate #parentId").val();
	var jsrq = $('#statisticwxyh_daily #attainmentrate #jsrq').val();
    $('#statisticwxyh_daily').load("/ws/statictis/backDailyByYhid?yhid="+yhid+"&jsrq="+jsrq);
});
function loadAttainmentRate(){
    //加载数据
    var _url = "/ws/statistics/getSalesAttainmentRateByArea";
    var param ={
        qymc:$("#statisticwxyh_daily #attainmentrate #qymc").val(),
        zblxcsmc:$("#statisticwxyh_daily #attainmentrate #zblx").val(),
        yhid:$("#statisticwxyh_daily #attainmentrate #yhid").val(),
        kszq:$("#statisticwxyh_daily #attainmentrate #searchkszq").val(),
        jszq:$("#statisticwxyh_daily #attainmentrate #searchjszq").val(),
        qyid:$("#statisticwxyh_daily #attainmentrate #qyid").val()
    };
    $.ajax({
        type : "post",
        url : _url,
        ...
        success : function(datas) {
            if(datas){
                ...
                var zblxmc = $("#statisticwxyh_daily #zblxmc").val();
                $("#statisticwxyh_daily #tatistics_attainmentrate_area").html("");
                ...
                table += "</body>";
                table += "</table></div>";
                $("#statisticwxyh_daily #tatistics_attainmentrate_area").append(table);
            }else{
...
function showSalesAttainmentRateDaliyByArea(yhid,zblxmc,qyid,qymc,kszq,jszq){
	var parentId = $("#statisticwxyh_daily #attainmentrate #parentId").val();
