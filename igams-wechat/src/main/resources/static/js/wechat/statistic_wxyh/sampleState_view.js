...
var percentage_wxyh=function (){
	$.ajax({
		url:'/ws/ststictis/getpercentageDaily',
		type:'post',
		data:{"jsrq":$("#jsrq").val(),"zt":$("#zt").val(),"jsrqstart":$("#jsrqstart").val(),"jsrqend":$("#jsrqend").val(),"jsrqMstart":$("#jsrqMstart").val(),"jsrqMend":$("#jsrqMend").val(),"jsrqYstart":$("#jsrqYstart").val(),"jsrqYend":$("#jsrqYend").val(),"yhid":$("#sample_formSearch_daily #yhid").val()},
		dataType:'JSON',
...
function go_backPage(){
	$("#statisticwxyh_daily").load("/ws/ststictis/go_back_dailyByYhid?jsrq="+$("#sample_formSearch_daily #jsrq").val()+"&yhid="+$("#sample_formSearch_daily #yhid").val());
}
$(function(){
