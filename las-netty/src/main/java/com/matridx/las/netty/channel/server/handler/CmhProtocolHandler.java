...
import com.matridx.las.netty.receivehandleimpl.CmhReceiveHandleImpl;

import io.netty.channel.ChannelHandler.Sharable;

@Service
@Sharable
public class CmhProtocolHandler extends MatridxProtocolHandler<CmhProtocol> {
	@Autowired
	private CmhReceiveHandleImpl cmhReceiveHandleImpl;
	@Override
	...
	protected String excuteCmd(FrameModel recModel) {
		boolean result = cmhReceiveHandleImpl.receiveHandle(recModel);
		if(result) {
			return "Success";
		}
		return "Fail";
