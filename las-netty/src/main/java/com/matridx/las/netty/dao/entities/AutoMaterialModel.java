 ...
 * 配置仪
 */
@Alias(value = "AutoMaterialModel")
public class AutoMaterialModel {
	private String commanddeviceid;
	private String deviceid;
	//Ep样本
	private List<AgvEpModel> sampleEpList;
	//八连管中的样本
	...
	private  String qy;
	private  String pzwz;
	private String sampleEpListCount="";
	...
	public List<AgvEpModel> getSampleEpList() {
		return sampleEpList;
	}

	public void setSampleEpList(List<AgvEpModel> sampleEpList) {
		this.sampleEpList = sampleEpList;
	}
	...
	public String getSampleEpListCount() {
		return sampleEpListCount;
	}

	public void setSampleEpListCount(String sampleEpListCount) {
		this.sampleEpListCount = sampleEpListCount;
	}
