...
@Component
public class LasNettyServer {
	
	@Value("${matridx.netty.port:8095}")
	private int port;
    ...
    public void start() throws Exception {
        ...
        // TODO Auto-generated method stub
 		...
 		try {
 			...
 			.childHandler(new LasServerChannelInitializer())
 			//设置队列大小
 			...
 			log.error("Netty服务器启动开始监听端口: {}", port);
 			// 等待服务器  socket 关闭 。
 			// 在这个例子中，这不会发生，但你可以优雅地关闭你的服务器。
 			serverChannel.closeFuture().sync();
 			
 			log.error("Netty服务器关闭？");
