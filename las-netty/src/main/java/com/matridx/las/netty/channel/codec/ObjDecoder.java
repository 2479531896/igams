...
import com.matridx.las.netty.channel.domain.PacketClazzMap;
import com.matridx.las.netty.channel.util.SerializationUtil;
...
public class ObjDecoder extends ByteToMessageDecoder {
	...
	protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
		...
		try {
			...
			//类方式的协议
			if(splitword == 64) {
				data = new byte[dataLength - 1]; //指令占了一位，剔除掉
				in.readBytes(data);
