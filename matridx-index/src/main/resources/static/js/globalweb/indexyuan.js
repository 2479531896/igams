				...
				$.each(data,function(i){
					...
					if(cdcc==2){
						...
						if(data[i].zylj.indexOf("?") <0)
							s_html +='<li><a data-addtab="' + data[i].zyid + '" data-url="' + data[i].zylj + '?access_token=' + $("#ac_tk").val() + '&zyid=' + data[i].zyid + '"';
						else
							s_html +='<li><a data-addtab="' + data[i].zyid + '" data-url="' + data[i].zylj + '&access_token=' + $("#ac_tk").val() + '&zyid=' + data[i].zyid + '"';
                        s_html +='href="javascript:void(0)" title="' + data[i].zybt + '">' + data[i].zybt + '</a>';
						s_html +='</li>';
						isFirst = false;
					}
				});
