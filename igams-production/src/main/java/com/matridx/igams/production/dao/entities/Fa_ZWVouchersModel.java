...
@Alias(value="Fa_ZWVouchersModel")
public class Fa_ZWVouchersModel {
	private String i_id;
	private String coutaccset;
	private String ioutyear;
	...
	private String bvouchedit;
	private String bvouchAddordele;
	private String bvouchmoneyhold;
	private String bvalueedit;
	private String bcodeedit;
	private String ccodecontrol;
	private String bPCSedit;
	private String bDeptedit;
	private String bItemedit;
	private String bCusSupInput;
	...
	private String cPzPropVal1;
	private String cPzPropVal2;
	private String cPzPropVal3;
	private String cPzPropVal4;
	...
	public String getIoutyear() {
		return ioutyear;
	}

	public void setIoutyear(String ioutyear) {
	...
	public String getMd_f() {
		return md_f;
	}

	public void setMd_f(String md_f) {
		this.md_f = md_f;
	}

	public String getMc_f() {
		return mc_f;
	}

	public void setMc_f(String mc_f) {
		this.mc_f = mc_f;
	}

	public String getNfrat() {
		return nfrat;
	}

	public void setNfrat(String nfrat) {
		this.nfrat = nfrat;
	}

	public String getNd_s() {
		return nd_s;
	}

	public void setNd_s(String nd_s) {
		this.nd_s = nd_s;
	}

	public String getNc_s() {
		return nc_s;
	}

	public void setNc_s(String nc_s) {
		this.nc_s = nc_s;
	}
	...
	public String getBvouchedit() {
		return bvouchedit;
	}

	public void setBvouchedit(String bvouchedit) {
		this.bvouchedit = bvouchedit;
	}

	public String getBvouchAddordele() {
		return bvouchAddordele;
	}

	public void setBvouchAddordele(String bvouchAddordele) {
		this.bvouchAddordele = bvouchAddordele;
	}

	public String getBvouchmoneyhold() {
		return bvouchmoneyhold;
	}

	public void setBvouchmoneyhold(String bvouchmoneyhold) {
		this.bvouchmoneyhold = bvouchmoneyhold;
	}

	public String getBvalueedit() {
		return bvalueedit;
	}

	public void setBvalueedit(String bvalueedit) {
		this.bvalueedit = bvalueedit;
	}

	public String getBcodeedit() {
		return bcodeedit;
	}

	public void setBcodeedit(String bcodeedit) {
	...
	public String getbPCSedit() {
		return bPCSedit;
	}

	public void setbPCSedit(String bPCSedit) {
		this.bPCSedit = bPCSedit;
	}

	public String getbDeptedit() {
		return bDeptedit;
	}

	public void setbDeptedit(String bDeptedit) {
		this.bDeptedit = bDeptedit;
	}

	public String getbItemedit() {
		return bItemedit;
	}

	public void setbItemedit(String bItemedit) {
		this.bItemedit = bItemedit;
	}

	public String getbCusSupInput() {
		return bCusSupInput;
	}

	public void setbCusSupInput(String bCusSupInput) {
	...
	public String getcPzPropVal1() {
		return cPzPropVal1;
	}

	public void setcPzPropVal1(String cPzPropVal1) {
		this.cPzPropVal1 = cPzPropVal1;
	}

	public String getcPzPropVal2() {
		return cPzPropVal2;
	}

	public void setcPzPropVal2(String cPzPropVal2) {
		this.cPzPropVal2 = cPzPropVal2;
	}

	public String getcPzPropVal3() {
		return cPzPropVal3;
	}

	public void setcPzPropVal3(String cPzPropVal3) {
		this.cPzPropVal3 = cPzPropVal3;
	}

	public String getcPzPropVal4() {
		return cPzPropVal4;
	}

	public void setcPzPropVal4(String cPzPropVal4) {
		this.cPzPropVal4 = cPzPropVal4;
	}
