...
@Mapper
public interface IHtfkmxDao extends BaseBasicDao<HtfkmxDto, HtfkmxModel>{
     ...
     * 根据搜索条件获取导出条数
     */
    int getCountForSearchExp(HtfkmxDto htfkmxDto);

    /**
     * 从数据库分页获取导出数据
     */
    List<HtfkmxDto> getListForSearchExp(HtfkmxDto htfkmxDto);

    /**
     * 从数据库分页获取导出数据
     */
    List<HtfkmxDto> getListForSelectExp(HtfkmxDto htfkmxDto);
