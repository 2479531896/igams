...
public class DateTimeUtil {
	...
	public static String getFormatDateV2(String date){
        ...
        return datearr[0] +
				"-" +
				(Integer.parseInt(datearr[1]) < 10 ? "0" + datearr[1] : datearr[1]) +
				"-" +
				(Integer.parseInt(datearr[2]) < 10 ? "0" + datearr[2] : datearr[2]);
	...
	public static String convertHexTime2Binary(String timespan) {
        ...
        for (String s : strArr) {
            StringBuilder binStr = new StringBuilder(Long.toBinaryString(Long.parseLong(s, 16)));
            if (binStr.length() < 32) {
	...
	public static String convertDecTime2Binary(String timespan) {
		...
		String[] strArr = timespan.split(",");
        for (String s : strArr) {
            StringBuilder binStr = new StringBuilder(Long.toBinaryString(Long.parseLong(s, 10)));
            if (binStr.length() < 32) {
                int length = binStr.length();
                for (int n = 0; n < 32 - length; n++) {
                    binStr.insert(0, "0");
