package com.matridx.springboot.util.dingtalk;
 ...
 * JDK6的下载地址：<a href="http://www.oracle.com/technetwork/java/javase/downloads/jce-6-download-429243.html">...</a>
 * JDK7的下载地址： <a href="http://www.oracle.com/technetwork/java/javase/downloads/jce-7-download-432124.html">...</a>
 */
public class DingCallbackCrypto {
    ...
    private final Logger log = LoggerFactory.getLogger(DingCallbackCrypto.class);
    /**
    ...
    public DingCallbackCrypto(String token, String encodingAesKey, String corpId) throws DingTalkEncryptException {
        ...
        //aesKey = encodingAesKey.substring(0,16).getBytes();
    }
    ...
    public String getDecryptMsg(String msgSignature, String timeStamp, String nonce, String encryptMsg)
        ...
        log.error("====================校验签名=====================token=" + token +":signature="+signature+":encryptMsg="+encryptMsg+":timeStamp="+timeStamp+":nonce="+nonce);
    ...
    public String getSignature(String token, String timestamp, String nonce, String encrypt)
        ...
        try {
            ...
            Arrays.sort(array);
                log.error("===========getSignature===timestamp:"+timestamp + " nonce:"+nonce + " array:"+JSON.toJSONString(array));
